...
class IDSet{
 ...
 IDList * GetI(int dID,IDList *dIHead,IDList *dITail);
  ...
  void DeleteI(int dID,IDList *dIHead,IDList *dITail,IDList *dVHead,IDList *dVTail,int nowID,int *dnum = NULL);
